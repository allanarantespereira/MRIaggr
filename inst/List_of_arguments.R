...
#### 43- coords_max #### 
Line 14 :   \item{coords_max}{the maximum coordinate in each dimension. \emph{numerical vector}} # MRIaggr-calcGroupsCoords_cpp.Rd

#### 44- coords_NNA #### 
Line 11 :   \item{coords_NNA}{the spatial coordinates of the observations in C version (beginning at 0). \emph{matrix}.} # MRIaggr-calcGroupsCoords_cpp.Rd
...
#### 108- index_NNA #### 
Line 12 :   \item{index_NNA}{the index of the coordinates in a array in C version (beginning at 0). \emph{numerical vector}.} # MRIaggr-calcGroupsCoords_cpp.Rd
...
#### 142- max_groups #### 
Line 15 :   \item{max_groups}{the maximum number of groups. \emph{postive integer}.} # MRIaggr-calcGroupsCoords_cpp.Rd
...
Line 13 :   \item{max_groups}{the maximum number of groups. \emph{postive integer}.} # MRIaggr-calcGroupsW.Rd
...
Line 13 :   \item{Neighborhood}{the type of neighbourhood. \emph{character}.} # MRIaggr-calcGroupsCoords_cpp.Rd
...
Line 12 :   \item{subset}{the subset of observations to use. \emph{positive integer vector} or \code{NULL} leading to use all observations.} # MRIaggr-calcGroupsW.Rd
...
Line 16 :   \item{verbose}{should the execution of the function be traced ? \emph{logical}.} # MRIaggr-calcGroupsCoords_cpp.Rd
...
Line 11 :   \item{W}{the neighbourhood matrix. \emph{dgCMatrix}. REQUIRED.} # MRIaggr-calcGroupsW.Rd
